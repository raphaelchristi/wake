...
>
> Phase 6 (multi-tenancy + RBAC + backup) endereça os 3 Tier 0 gaps. Backend tenancy primitives shipped em `89bec12` (`v0.5.3-tenancy-backend`); slices RBAC/frontend/ops em paralelo.
