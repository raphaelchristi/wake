...
### Billing, quotas e comercialização

Wake core expõe `organization_id`/`workspace_id` como fronteira de
isolamento. Billing, planos, cobrança, limits comerciais e UX de account
management continuam sendo produto por cima.
